...
c            the versiontag in blockres.f !
      ...
      parameter ( version = 40000) ! version number
      parameter ( laires  = 40000) ! additional tag
      parameter ( versiontxt = '4.0' )
...
c  Coordinates of clusters fro coalescence
         real*8 r0cl(500),rxcl(500),rycl(500),rzcl(500)
         integer lstcollcl(500),ncollcl(500),idcl(500)
         real*8 p0cl(500),pxcl(500),pycl(500),pzcl(500)
         real*8 mcl(500)
         integer chgcl(500),isocl(500),itypcl(500)
         common /cluster/ r0cl,rxcl,rycl,rzcl,lstcollcl,
     &   ncollcl,p0cl,pxcl,pycl,pzcl,mcl,chgcl,isocl,itypcl,
     &   idcl
