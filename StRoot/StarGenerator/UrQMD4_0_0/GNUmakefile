...
all: nolhc $(TARGET)    $(TABLE) inputfile
	@echo "UrQMD executable $(TARGET) created, for calculations at LHC energies we suggest modifying the output.f formats"
...
$(OBJDIR)/init.o:      boxinc.f colltab.f comhis.f coms.f comres.f freezeout.f inputs.f \
                       newpart.f options.f
...
$(OBJDIR)/output.o:    boxinc.f comhis.f coms.f comres.f freezeout.f inputs.f newpart.f \
                       options.f
...
$(OBJDIR)/$(MAIN).o:   boxinc.f colltab.f comhis.f coms.f comres.f inputs.f newpart.f \
                       options.f
